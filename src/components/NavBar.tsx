export default function NavBar() {
  return (
<header className="p-4 bg-gray-800 text-gray-100 dark:text-gray-800">
	<div className="container flex justify-between h-8 mx-auto">
		<ul className="items-stretch hidden space-x-3 lg:flex">
			<li className="flex">
				<a rel="noopener noreferrer" href="/" className="flex items-center px-4 -mb-1 border-b-2 dark:border- text-white hover:text-green-400 transition-colors">Seus Cursos</a>
			</li>
			<li className="flex">
				<a rel="noopener noreferrer" href="/salas" className="flex items-center px-4 -mb-1 border-b-2 dark:border- text-white hover:text-green-400 transition-colors">Suas Salas</a>
			</li>
		</ul>
		...
		<button title="Open menu" type="button" className="flex items-center justify-center p-4 lg:hidden">
