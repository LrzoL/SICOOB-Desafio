...
export default function ChatBot() {
    ...
    return (
        <div className="z-11 fixed h-[60%] w-[80%] mb-30 rounded-lg bg-gray-300 bottom-0">
            ...
            <div className="w-full h-full flex flex-col items-center justify-center">
                <div className="w-full h-full p-4 rounded-t-lg flex items-center justify-center">
                    <h2 className="text-center text-2xl font-bold text-gray-800">Olá, eu sou o EduAI, como posso ajudar?</h2>
                </div>
